...
export class Migrations1691096322272 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "budget_goal" ADD CONSTRAINT "FK_ffa781323297966ce08f0213b4a" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "wallet" ADD CONSTRAINT "FK_dffe91708c34dedf8dffbccd5d8" FOREIGN KEY ("bankId") REFERENCES "bank"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "wallet" DROP CONSTRAINT "FK_dffe91708c34dedf8dffbccd5d8"`);
        await queryRunner.query(`ALTER TABLE "budget_goal" DROP CONSTRAINT "FK_ffa781323297966ce08f0213b4a"`);
